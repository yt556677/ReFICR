...
class CustomTrainingArguments(TrainingArguments):
    ...
    in_batch_neg: bool = field(
        default=False, 
        metadata={
            "help": "This argument will control in-batch negatives or contructed negatives."
        }
    )
    ...
    lora: bool = field(default=True, metadata={"help": "Use LoRA PEFT"})
    lora_r: int = field(default=64, metadata={"help": "LoRA rank"})
    lora_alpha: int = field(default=16, metadata={"help": "LoRA regualization"})
    lora_dropout: float = field(default=0.05, metadata={"help": "dropout"})
    lora_bias: str = field(default="none", metadata={"help": "bias"})
